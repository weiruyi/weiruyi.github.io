import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as e,a as s,b as a,o as i}from"./app-Df1eO15o.js";const l="/image/project/p10.png",t="/image/project/p11.png",r="/image/project/p12.png",d="/image/project/p13.png",o="/image/project/p14.png",c="/image/project/p15.png",u="/image/project/p16.png",p="/image/project/p17.png",v={},m=a('<h1 id="缓存优化" tabindex="-1"><a class="header-anchor" href="#缓存优化"><span>缓存优化</span></a></h1><h2 id="一、redis缓存" tabindex="-1"><a class="header-anchor" href="#一、redis缓存"><span>一、Redis缓存</span></a></h2><p>课程发布信息的特点的是查询较多，修改很少，这里考虑将课程发布信息进行缓存。</p><p>课程信息缓存的流程如下：</p><figure><img src="'+l+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>在nacos配置redis-dev.yaml（group=xuecheng-plus-common）</p><div class="language-Java line-numbers-mode" data-ext="Java" data-title="Java"><pre class="language-Java"><code>spring: 
  redis:
    host: 192.168.101.65
    port: 6379
    password: redis
