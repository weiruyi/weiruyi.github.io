import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as s,a,d as e,o as p}from"./app-CwUAqAGx.js";const t={},o=e(`<h1 id="sql语句" tabindex="-1"><a class="header-anchor" href="#sql语句"><span>SQL语句</span></a></h1><h2 id="_1、数据库操作" tabindex="-1"><a class="header-anchor" href="#_1、数据库操作"><span>1、数据库操作</span></a></h2><div class="language-sql line-numbers-mode" data-ext="sql" data-title="sql"><pre class="language-sql"><code><span class="token comment"># 查询所有数据库</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,22);function c(l,i){return p(),s("div",null,[a("more-"),o])}const k=n(t,[["render",c],["__file","index.html.vue"]]),u=JSON.parse('{"path":"/posts/old%E5%AD%98%E6%A1%A3/%E6%95%B0%E6%8D%AE%E5%BA%93/","title":"SQL语句","lang":"zh-CN","frontmatter":{"title":"SQL语句","date":"2024-05-22T16:14:58.000Z","tags":"mysql","category":"数据库","icon":"/img/SQL.svg","order":1,"description":"SQL语句 1、数据库操作 2、表操作 3、数据操作 4、单表查询 5、多表查询 连接查询 内连接：相当于查询A,B交集的部分数据 外连接： 左外连接：查询左表的所有数据（包括两张表的交集部分） 右外连接：查询右表的所有数据（包括两张表的交集部分） 6、事务 一组操作的集合。它是一个不可分割的工作单位，事务会把所有操作作为一个整体一起向系统提交，即这些...","head":[["meta",{"property":"og:url","content":"https://mister-hope.github.io/posts/old%E5%AD%98%E6%A1%A3/%E6%95%B0%E6%8D%AE%E5%BA%93/"}],["meta",{"property":"og:site_name","content":"Lance"}],["meta",{"property":"og:title","content":"SQL语句"}],["meta",{"property":"og:description","content":"SQL语句 1、数据库操作 2、表操作 3、数据操作 4、单表查询 5、多表查询 连接查询 内连接：相当于查询A,B交集的部分数据 外连接： 左外连接：查询左表的所有数据（包括两张表的交集部分） 右外连接：查询右表的所有数据（包括两张表的交集部分） 6、事务 一组操作的集合。它是一个不可分割的工作单位，事务会把所有操作作为一个整体一起向系统提交，即这些..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2026-02-10T11:21:07.000Z"}],["meta",{"property":"article:author","content":"RuyiWei"}],["meta",{"property":"article:published_time","content":"2024-05-22T16:14:58.000Z"}],["meta",{"property":"article:modified_time","content":"2026-02-10T11:21:07.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"SQL语句\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2024-05-22T16:14:58.000Z\\",\\"dateModified\\":\\"2026-02-10T11:21:07.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"RuyiWei\\"}]}"]]},"headers":[{"level":2,"title":"1、数据库操作","slug":"_1、数据库操作","link":"#_1、数据库操作","children":[]},{"level":2,"title":"2、表操作","slug":"_2、表操作","link":"#_2、表操作","children":[]},{"level":2,"title":"3、数据操作","slug":"_3、数据操作","link":"#_3、数据操作","children":[]},{"level":2,"title":"4、单表查询","slug":"_4、单表查询","link":"#_4、单表查询","children":[]},{"level":2,"title":"5、多表查询","slug":"_5、多表查询","link":"#_5、多表查询","children":[]},{"level":2,"title":"6、事务","slug":"_6、事务","link":"#_6、事务","children":[]},{"level":2,"title":"7、索引","slug":"_7、索引","link":"#_7、索引","children":[]}],"git":{"createdTime":1719643575000,"updatedTime":1770722467000,"contributors":[{"name":"weiruyi","email":"1581778251@qq.com","commits":1}]},"readingTime":{"minutes":6.68,"words":2003},"filePathRelative":"posts/old存档/数据库/README.md","localizedDate":"2024年5月22日","excerpt":"<!--more--->\\n<h1>SQL语句</h1>\\n<h2>1、数据库操作</h2>\\n<div class=\\"language-sql\\" data-ext=\\"sql\\" data-title=\\"sql\\"><pre class=\\"language-sql\\"><code><span class=\\"token comment\\"># 查询所有数据库</span>\\n<span class=\\"token keyword\\">show</span> <span class=\\"token keyword\\">databases</span><span class=\\"token punctuation\\">;</span>\\n\\n<span class=\\"token comment\\"># 创建数据库</span>\\n<span class=\\"token keyword\\">create</span> <span class=\\"token keyword\\">database</span> db02<span class=\\"token punctuation\\">;</span>\\n\\n<span class=\\"token comment\\"># 删除数据库</span>\\n<span class=\\"token keyword\\">drop</span> <span class=\\"token keyword\\">database</span> db02<span class=\\"token punctuation\\">;</span>\\n</code></pre></div>","autoDesc":true}');export{k as comp,u as data};
